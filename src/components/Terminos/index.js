  ...
  return (
    ...
    >
      <motion.div
        ...
        onClick={onClose}
        initial={{ opacity: 0 }}
        className={styles.terminos_overlay}
        animate={isOpen ? 'open' : 'closed'}
      />
      <motion.div
        variants={scale}
        initial={{ scale: 0 }}
        className={styles.terminos_box}
        animate={isOpen ? 'open' : 'closed'}
      >
        ...
        <div className={styles.terminos_content}>
          <p>
            ...
            Decreto Supremo N° 003-2013-JUS, en la que todo momento buscará que
            el tratamiento de los mismos sea legítimo, controlado e informado,
          ...
          <p>
            ...
            transferencia o cualquier otra forma de procesamiento que facilite
            el acceso, correlación o interconexión de sus datos personales, así
            como su incorporación a bases de datos administradas o de
            titularidad del ELA, así como de la información que se derive de su
            uso y de cualquier información pública o que pudiera recoger de
          ...
          <p>
            ...
            “agendar cita”, “contratar”, “aceptar”, “solicitar” y/o cualquier
            otra definición similar, así como el solo acto de brindarnos sus
            datos o de navegar por el Sitio Web, se manifiesta de por sí un
            consentimiento por parte del titular.
          </p>

          <p>
            CUARTO: lo mencionado en la cláusula precedente es indispensable
            para que el ELA pueda prestar sus servicios ofrecidos, por lo que en
            caso manifieste su negativa el ELA podrá excluirlo de su base de
            datos o dar de baja su registro o base de datos, a fin de no afectar
          ...
          <p>
            ...
            y/ otras actividades promovidas. Asimismo, la Información del
            usuario podrá ser cedida o compartida con empresas terceras no
            vinculadas con el ELA a fin de que pueda contactar y ofrecer al
            usuario cualquier información comercial, publicitaria y/o
            promocional sobre los productos y/o los servicios de empresas
            terceras de distintos sectores
          </p>

          <p>
            SEXTO: El ELA protege los datos personales frente a pérdidas
            fortuitas, accesos, tratamientos o revelaciones no autorizados,
